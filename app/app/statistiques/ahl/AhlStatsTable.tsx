          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b">
                ...
                <th className="sticky top-0 z-10 bg-gray-50 text-right px-4 py-3 font-medium text-gray-600 hidden sm:table-cell">+/-</th>
                <th className="sticky top-0 z-10 bg-gray-50 text-right px-4 py-3 font-medium text-gray-600 hidden sm:table-cell">PUN</th>
              </tr>
            </thead>
            <tbody>
